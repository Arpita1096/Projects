...
public class Arpita_atm_{
    ...
    public static class AtmOperationImpl implements Atm_Operation_Interface {
        String name;
        String userName;
        String password;
        int accountNo;
        float balance = 70000f;
        int transactions = 0;
    ...
    public static void main(String[] args){
        ...
        Atm_Operation_Interface op= new AtmOperationImpl();
        Scanner in = new Scanner(System.in);


        System.out.println("**********Welcome To ARPITA Atm Machine********** \n");

        int atmnumber=565656;
        int atmpin=98765;
        ...
        if((atmnumber==atmNumber && atmpin==pin)) {
            ...
            while(true) {
                ...
                if(bal==5) {
                    System.out.println("Collect Your Atm Card !!...\nThank you for using ARPITA Atm Machine!!.. ");
                    System.exit(0);
                }
            }
