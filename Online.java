...
class about{
    void display(){
        ...
        System.out.println("Mail : arpita@gmail.com");
    }
}
    ...
    public void m2(){
        ...
        while(true){
            ...
            if(opt == 1){
                ...
                System.out.println("\n-- ARPITA Online Examination Portal --");
                System.out.println("\nDesigned by :\nArpita Vaish ");
                System.out.println("\n1.Back            2.Exit");
                int g3=sc.nextInt();
                if(g3==1){
...
class sci{
    ...
    void s1(){
        ...
        System.out.println("\nQuestion No.2	 :");
        System.out.println("\nIndia celebrates National Sports Day on ?");
        System.out.println("\n1. 29 August");
        ...
        System.out.println("\nQuestion No.4	 :");
        System.out.println("\nMultiple Inheritance is possible in Java through ?");
        System.out.println("\n1. Abstract class");
...
class eng{
    ...
    void e1(){
        ...
        System.out.println("\nQuestion No.4	 :");
        System.out.println("\nAparajita has no siblings she is............child ?");
        System.out.println("\n1.a lonely");
        ...
        System.out.println("\nQuestion No.7	 :");
        System.out.println("\nWhen Varun reached the auditorium they had.........left ?");
        System.out.println("\n1.already");
...
class mat{
    ...
    void mat1(){
        ...
        System.out.println("\nQuestion No.4	 :");
        System.out.println("\nWhat does the Roman Numeric (C) represents ?");
        System.out.println("\n1.one");
...
public class Online{
    public static void main(String []args){
        ...
        Scanner sc=new Scanner(System.in);
        System.out.println("\nWelcome to ARPITA Online Examination Portal !!");
        System.out.println("\n1.Login\n2.SignUp");
        System.out.println("\nEnter your option ");
        int r=sc.nextInt();
        if(r == 1){
